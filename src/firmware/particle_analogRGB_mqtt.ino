/***
Particle-Photon sketch to control RGB LED strips over the wifi local network using MQTT
Author: Ayan Pahwa
Date  : December 23rd 2016
***/

//Reused code from old project, details: https://github.com/iayanpahwa/OpenHab-Particle-MQTT-master
